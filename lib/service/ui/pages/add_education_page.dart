...
class AddExperiencePageState extends ConsumerState<AddEducationPage> {
  final _formKey = GlobalKey<FormState>();

  final TextEditingController titreCtrl = TextEditingController(text: '');
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              // Champ Prénom
              Text(
                'Ajouter votre parcours scolaire & academique',
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Veuillez entrer votre diplome';
                  }
                  return null;
                },
              ),
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      ctrl.saveEtude(etude);

                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'nouvelle parcours ajouter avec succées',
                            style: TextStyle(
                              //color: Colors.white,
                              fontFamily: 'Poppins',
                            ),
